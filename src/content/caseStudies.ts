...
export const caseStudies: CaseStudy[] = [
  {
    ...
    blocks: [
      ...
      {
        kind: 'paragraph',
        text: 'Of 40 surveyed first-time job seekers (21–26, Tier 1/2 cities), 100% knew voice existed and most had tried it — but 78% never used it again after one failed attempt. 64% cited Hinglish or accent misrecognition as the cause, and 52% described the failure as embarrassing, not just inconvenient. Only 12% got any in-app explanation of what went wrong. The obvious read — "voice isn’t discoverable" — was wrong from the start; the real problem was that a single bad transcript permanently killed trust, with no recovery path offered.',
      },
      {
        kind: 'metrics',
        items: [
      ...
      { kind: 'heading', text: 'What I did' },
      {
        ...
        items: [
          ...
          'Chose Voice Recovery Coach because it repairs the actual failure moment directly, rather than trying to prevent all failures in advance (Learner Mode) or just prompting more voice use without fixing trust (Nudge) — and kept Learner Mode as a documented alternative to revisit, not a discarded idea.',
