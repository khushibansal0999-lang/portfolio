...
export const roles: RoleEntry[] = [
  {
    ...
    location: 'Remote',
    scope:
      'Solo PM + builder on every project — no team, no dedicated engineer, full ownership of research through prototype.',
    isCurrent: true,
    bullets: [
      {
      ...
      {
        text: 'CineVerse AI (Jul 2026) — a personalized movie/book recommender: 10-entity data model, 17-page PRD with Given/When/Then acceptance criteria, MoSCoW prioritization with 6 explicit non-goals.',
      },
      {
        text: 'Ascend (Jul 2026) — a gamified habit tracker; prioritized the core XP + streaks loop over secondary features in v1 to validate the retention mechanic first.',
      },
      {
  ...
  },
  {
    ...
    scope:
      'Sole engineering owner of 3 production firmware modules with no dedicated PM — problem definition, specs, acceptance criteria, phased rollout across millions of vehicles — coordinating cross-functionally across 6 teams (hardware, firmware, QA, PM, system integration, GTM).',
    bullets: [
      {
      ...
      {
        text: 'Charge optimization: designed a dual-simplex LP balancing fast-charge current against health, temperature, SoC, and voltage limits — cut charge time without degrading battery health, +30% charge-time prediction accuracy.',
      },
      {
        text: 'Safety/performance tradeoff: scoped an unaddressed safety risk from field data and shipped a predictive core-temperature model (MPC); chose progressive de-rating over a hard cutoff, trading minor peak performance for reliability.',
      },
      {
