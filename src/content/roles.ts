...
export const roles: RoleEntry[] = [
  ...
  },
  {
    ...
    scope:
      'Sole engineering owner of 3 production firmware modules with no dedicated PM. Problem definition, specs, acceptance criteria, and phased rollout across millions of vehicles, coordinating cross-functionally across 6 teams (hardware, firmware, QA, PM, system integration, GTM).',
    bullets: [
      {
      ...
      {
        text: 'Charge optimization: designed a dual-simplex LP balancing fast-charge current against health, temperature, SoC, and voltage limits, cutting charge time without degrading battery health, +30% charge-time prediction accuracy.',
      },
      {
